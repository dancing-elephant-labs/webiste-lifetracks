    ...
    <nav className="fixed top-0 left-0 right-0 z-50 flex justify-center p-4">
      ...
      {isOpen && (
        ...
        >
          ...
          <a href="#features" className="text-xl font-semibold text-foreground/70 hover:text-foreground py-3 border-b border-border" onClick={() => setIsOpen(false)}>Features</a>
